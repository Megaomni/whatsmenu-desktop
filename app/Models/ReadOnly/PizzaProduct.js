...
class PizzaProduct extends Model {
  ...
  complements() {
    return this.belongsToMany('App/Models/ReadOnly/Complement', 'pizzaId', 'complementId', 'id', 'id').pivotTable('pizza_complements')
  }

  cartItens() {
    return this.hasMany('App/Models/ReadOnly/CartIten', 'id', 'pizzaId')
  }
}
