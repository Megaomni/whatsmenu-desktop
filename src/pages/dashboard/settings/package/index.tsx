...
import { apiRoute, compareItems, copy, currency, mask, textPackage } from '../../../../utils/wm-functions'
          ...
          <Row>
            <Card>
              <Card.Header className='d-flex gap-3'>
                ...
                <HelpVideos.Trigger urls={[{ src: 'https://www.youtube.com/embed/BGBA9120Y_A', title: 'Configurações de Encomendas' }]} />
              </Card.Header>
              <Card.Body>
                <Row>
                  <Col sm="12" md>
