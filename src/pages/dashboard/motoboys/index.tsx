...
export default function Motoboys({ }: MotoboysProps) {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      console.error('Error ao adicionar motoboy', error)
      throw error
    }
  }
  ...
  const handlePause = async (motoboy: any) => {
    try {
      ...
      console.error('Erro ao pausar/ativar motoboy', error)
    }
  }
  ...
  const saveEdit = async (motoboy: any) => {
    try {
      ...
      console.error('Error ao editar entregador', error)
    }
  }
  ...
  return (
    <>
      <Title title="Entregadores" componentTitle="Entregadores" className="mb-4 fw-600" />
      <Card>
        <Card.Header className="d-flex gap-3">
          <h4 className="">Cadastro de Entregadores</h4>
          <div className="vr"></div>
          <HelpVideos.Trigger urls={[{ src: 'https://www.youtube.com/embed/nofncdMpVM4', title: 'Entregadores' }]} />
        </Card.Header>
            ...
            <Row className="d-flex mb-2 gap-1">
              <Col sm={12} lg={4} className="p-0 m-0">
                <Form.Group className="mb-1 mb-sm-0 p-1" style={{ width: '100%' }}>
                  <FormLabel className="fw-600 fs-7">Nome do Entregador:</FormLabel>
                  <Form.Control
                    type="text"
      ...
      <>
        <div>
          <h1 className="fs-3 align-middle text-uppercase mb-3">Entregadores Cadastrados </h1>
          <Card>
