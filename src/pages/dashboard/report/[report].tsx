...
export default function Report({ report, isValid, ...props }: ReportProps) {
  ...
  if (isValid || validation) {
    ...
    switch (report) {
      case 'finance':
        return <>
          <Title title="Relatório Financeiro" componentTitle="Financeiro" className="mb-4" />
          <div className='d-flex align-self-end mb-3'>
            <HelpVideos.Trigger urls={[{ src: 'https://www.youtube.com/embed/oYUhPHihzq0', title: 'Relatorio Financeiro' }]} className="ms-auto" />
          </div>
          <Card>
            <Card.Header>
            ...
            <Card.Body>
              <Link href="" legacyBehavior>
                ...
                >
                  Clique aqui para ver o detalhado!
                </Button>
              </Link>
              <hr />
          ...
          <Card>
            <Card.Header>
              <h4>Resumo dos últimos 12 meses</h4>
            </Card.Header>
            <Card.Body>
      ...
      case 'daily':
        return (
          <>
            <Title title="Pedidos Diários" componentTitle="Relatório de Pedidos Diários" className="mb-4" />
      ...
      case 'monthly':
        return (
          <>
            <Title title="Pedidos Mensais" componentTitle="Relatório de Pedidos Mensais" className="mb-4" />
            <ReportsLayout setData={setData} data={data} setResume={setResume} resume={resume} type={report} />
          </>
        )
      case 'cashier':
        return (
          <>
            <Title title="Encerramentos de Caixas" componentTitle="Relatório de Caixas" className="mb-4" />
      ...
      case 'client':
        return (
          <>
            <Title title="Relatório de Clientes" componentTitle="Relatório de Clientes" className="mb-4" />
      ...
      case 'bestSellers':
        return (
          <>
            <Title title="Relatório de Mais Vendidos" componentTitle="Os Mais Vendidos" className="mb-4" />
