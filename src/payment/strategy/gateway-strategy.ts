...
interface GatewayStrategy {
    ...
    addSubscriptionDiscount?: (discount: AddSubscriptionDiscountContracts) => Promise<any>;
    addSubscriptionItem?: (item: AddSubscriptionItemContracts) => Promise<any>;
    addSubscriptionIncrement?: (increment: AddSubscriptionIncrementContracts) => Promise<any>;
    changeChargeCard?: (cardId: string, data: ChangeChargeCardContracts) => Promise<any>;
    ...
    createSubscription?: (subscription: CreateSubscriptionContracts) => Promise<any>;
