...
import { BsGearFill, BsYoutube } from "react-icons/bs";
...
import { setCurrentTableIdAction } from "../../../reducers/tables/actions";
import { HelpVideos } from "../../Modals/HelpVideos";
// import { setCurrentTableIdAction } from "../../../reducers/tables/actions";

export function Tables() {
  const { data: session } = useSession();
  const { handleShowToast, handleHelpVideo } = useContext(AppContext);
  let { tables, setTables, table, setCurrentTableId, setCommandInfo } =
            ...
            <>
              <Row className="mt-3">
                ...
                <Col md className="d-flex justify-content-end">
                  <HelpVideos.Trigger urls={[{ src: "https://www.youtube.com/embed/tkPI7P9uQJU", title: "Criando mesa" }]} />
                </Col>
              </Row>
            </>
          ) : (
