        ...
        <Card.Body>
          ...
          <Col className="mb-2">
              ...
              <Form.Select {...register("incomeValue", { required: true })}>
                ...
                {/* <option value="UP_TO_50K"></option>
                <option value="FROM_50K_TO_100K"></option>
                <option value="FROM_100K_TO_250K"></option>
                <option value="FROM_250K_TO_1MM"></option>
                <option value="FROM_1MM_TO_5MM"></option>
                <option value="ABOVE_5MM"></option> */}
              </Form.Select>
              <Form.Control
                placeholder="Seu rendimento mensal"
                className={`${errors.email && 'is-invalid'} `}
                {...register('incomeValue', { required: true, minLength: 3 })}
              />
            </Col>
          </Row>
          <Row>
          ...
          <div className="d-lg-flex gap-4 justify-content-center">
            <div className="d-flex flex-column align-items-center">
              ...
              >
                <p className="m-0 p-0">
                  de: <strong style={{ textDecoration: 'line-through' }}> R$0,99</strong>
                </p>
                <p className="text-primary d-flex gap-2 m-0 p-0">
                  <span className="mt-1">por:</span>
                  <h3 className="p-0 m-0">
                    <strong>R$ 0,49</strong>
                  </h3>
                </p>
