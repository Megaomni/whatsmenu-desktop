...
export function AddressModal(props: AddressModalProps) {
  ...
  return <>
    <Modal show={show} onHide={handleClose} size="lg" centered>
      ...
      <Modal.Header>
        <h3>
          <b>{profile.address?.street ? "Editar endereço" : (
            <div className="d-flex gap-3">
              <span>
                Adicionar endereço
              </span>
              <div className="vr"></div>
              <HelpVideos.Trigger urls={[{ title: "Preenchendo o Endereço do Estabelecimento", src: "https://www.youtube.com/embed/xvhzTd_BRZo" }]} />
            </div>
          )}</b>
        </h3>
      </Modal.Header>
