    ...
    <>
      ...
      <Card>
        <Card.Header className="d-flex gap-3">
          ...
          <HelpVideos.Trigger urls={[{ src: 'https://www.youtube.com/embed/DF8j9EV58rI', title: 'Relatório de Entregadores' }]} />
        </Card.Header>
                    ...
                    </thead>
                    {
                      <tbody>
                        {data?.motoboy?.carts?.data &&
                          data?.motoboy.carts.data.map((c: CartType) => new Cart(c)).map((cart: Cart, index: any) => (
                            <tr key={index}>
                              <td>
                              ...
                              <td>R$ {cart?.getTotalValue('total').toFixed(2)}</td>
                              <td>R$ {Number(cart.taxDelivery).toFixed(2)}</td>
                            </tr>
                          ))}
                      </tbody>
                    }
