  ...
  return (
    <>
      ...
      <div>
        ...
        <h4 className="with-icon cursor-pointer">Gestão
          {
            window.innerWidth > 600 &&
            <OverlayTrigger placement="right" overlay={popover}>
              <Button variant="none" className="p-0 m-0"><BsInfoCircle size={20} /></Button>
            </OverlayTrigger>
          }
        </h4>
        <span className="d-sm-inline d-block align-middle float-md-end">
          <small>
            <a rel="noreferrer"  href="#" className="link-danger fw-bold"
              onClick={(e) => {
                e.preventDefault();
                setHelpVideoModal({
                  show: true,
                  src: "https://www.youtube.com/embed/wLZQUz84tOY"
                })
              }}
            >
              Veja Como Usar <BsYoutube />
            </a>
          </small>
        </span>
      </Card.Header> */}
