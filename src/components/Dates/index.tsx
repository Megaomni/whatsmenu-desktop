...
export function Dates({ setInvalidWeek, ...props }: DatesProps) {
  ...
  switch (type) {
    case 'menu':
      video = { src: 'https://www.youtube.com/embed/3CKI4sh9wKA', title: 'Disponibilidade de produtos' }
      break;
    default:
      video = { src: 'https://www.youtube.com/embed/POrBnzbrSm4', title: 'Cadastrando horários de funcionamento' }
      break;
  }
