...
export interface ProfileOptions {
  ...
  asaas: {
    ...
    incomeValue?: number
    webhooks?: WebhooksAsaas[]
    antecipation?: {
      limit: AntecipationLimitis
    }
  }
  legacyPix?: boolean
  voucher: Array<{
...
export interface WebhooksAsaas {
  id: string
  url: string
  name: string
  email: string
...
interface AntecipationLimitis {
  creditCard: AntecipationLimitValues
  bankSlip: AntecipationLimitValues
}

type AntecipationLimitValues = {
  total: number
  available: number
}
