...
var ar_AE_default = {
  ...
  text: {
    ...
    street: "Street",
    pickup_the_location: "I will pick up at the location",
    order_comment: "Order",
    schedule: "Schedule",
...
var fr_CH_default = {
  ...
  text: {
    ...
    crust_without_filling: "borda sem recheio",
    ...
    next_confirm: "Pr\xF3ximos/Confirmar",
    shortcuts: "atalhos",
...
var pt_PT_default = {
  ...
  text: {
    ...
    no_time_up: "SEM HOR\xC1RIO",
    contact: "Contato",
    favorite_card_comment: "Ex: O meu cart\xE3o favorito",
    finalize_order_comment: "Finalizar Pedido",
    welcome: "bem-vindo",
    loading: "a carregar",
    hello: "ol\xE1!",
    ...
    opened: "aberto",
    closed: "fechado",
    no_categories_available_at_moment: "N\xE3o h\xE1 categorias dispon\xEDveis para pedidos tipo mesa no momento.",
    check_admin_panel_categories_active: "Verifique o painel de administra\xE7\xE3o para garantir que as categorias est\xE3o ativas e dispon\xEDveis para pedidos tipo mesa.",
    cart_empty: "Carrinho Vazio",
    optional: "Opcional",
    add: "Adicionar",
    add_comment: "+Adicionar",
    obs: "Observa\xE7\xF5es",
    whatsapp: "N\xFAmero de Telefone",
    my_orders: "meus pedidos",
    tax_and_time_of_shipping: "taxa e tempo de envio",
    delivery: "Entrega",
    ...
    remove: "remover",
    shipping: "Envio",
    select_shipoing: "Selecionar Envio",
    edit: "editar",
    take_out: "Retirar no Local",
    cupom: "cupom",
    active_your_cupom: "ativar o seu cupom",
    code_of_cupom: "c\xF3digo do cupom",
    total: "total",
    select_the_form_of_shipping: "selecionar a forma de envio",
    obrigatory: "obrigat\xF3rio",
    go_to_payment: "ir para pagamento",
    payment: "Pagamento",
    pay_on_app: "pagar no app",
    ...
    payment_in: "pagamento em",
    payment_in_comment: "Pagamento em",
    i_need_transhipment: "preciso de transbordo para",
    i_not_need_transhipment: "N\xE3o Preciso de Transbordo",
    secret_number_on_note: "NIF na nota",
    search_products_by_name_or_description: "Pesquisar Produtos por Nome ou Descri\xE7\xE3o",
    outside_the_coverage_area: "fora da \xE1rea de cobertura",
    unavilable: "indispon\xEDvel",
    avaible: "dispon\xEDvel",
    ...
    free_comment_up: "GR\xC1TIS",
    add_address: "Adicionar Endere\xE7o",
    covered_address: "Endere\xE7o Coberto",
    send_order: "enviar pedido",
    you_are_blocked: "est\xE1 bloqueado",
    enter_your_cell: "insira o seu celular",
    enter_your_email: "insira o seu email",
    enter_your_address: "insira o seu endere\xE7o",
    enter_you_ddd: "insira o seu celular com DDD",
    minimum_unconceived_value: "valor m\xEDnimo n\xE3o concebido",
    finish_payment_pix: "finalizar pagamento pix",
    finish_payment: "finalizar pagamento",
    payment_online: "pagamento online",
    ...
    i_need_change_for: "preciso de troco para",
    i_dont_need_change: "n\xE3o preciso de troco",
    send_the_receipt: "envie o recibo para o nosso whatsapp para agilizar o seu atendimento",
    copy_key: "copiar chave",
    select_the_flag: "selecionar a bandeira",
    select_the_flag_comment: "Selecione a Bandeira",
    select: "Selecionar",
    cpf_on_the_receipt: "NIF no recibo",
    how_to_pay_with_pix: "Como pagar com PIX",
    enter_cpf_generate_pix: "Introduza o seu NIF para gerar uma chave PIX",
    enter_cpf: "Introduza o seu NIF",
    enter_a_valid_cpf: "Introduza um NIF v\xE1lido",
    order_pending_payment: "pedido pendente de pagamento",
    generate_pix_key: "Gerar chave PIX",
    pix_copy_paste: "PIX Copiar e colar",
    copy_code: "copiar c\xF3digo",
    pix_key_expired: "A sua chave PIX expirou. Clique no bot\xE3o para gerar um novo c\xF3digo",
    paste_this_code_your_bank: "Cole este c\xF3digo na op\xE7\xE3o Copiar e Colar PIX do seu banco",
    verify_pix_payment: "Verificar Pagamento PIX",
    card_details: "detalhes do cart\xE3o",
    name_on_the_card: "nome no cart\xE3o",
    card_number: "n\xFAmero do cart\xE3o",
    expiry: "data de validade",
    card_nickname: "apelido do cart\xE3o (opcional)",
    billing_adress: "endere\xE7o de fatura\xE7\xE3o",
    zip_code: "C\xF3digo Postal",
    zip_code_not_found: "C\xF3digo Postal n\xE3o encontrado",
    adress_line_2: "linha de endere\xE7o 2 (opcional)",
    order_will_be_delivered: "o pedido ser\xE1 entregue em",
    ...
    flavor_comment: "Sabor",
    crust: "massa",
    general_toppings: "toppings gerais",
    single_crust: "massa simples",
    message_cvv_payment: "Introduza o c\xF3digo CVV do seu cart\xE3o para completar o pagamento",
    code_back_of_your_card: "este c\xF3digo est\xE1 localizado na parte de tr\xE1s do seu cart\xE3o",
    complete_payment: "completar pagamento",
    delete: "eliminar",
    what_card_nickname: "qual \xE9 o apelido deste cart\xE3o",
    save: "Guardar",
    what_your_name: "Qual \xE9 o seu nome",
    open_new_order: "Abrir novo pedido",
    enter_name_your_order: "Introduza um nome para o seu pedido",
    select_order: "Selecionar um pedido",
    addition: "Adi\xE7\xE3o",
    use_cashback: "usar saldo de cashback",
    balance: "saldo",
    indentify_yourself: "identifique-se",
    whatsapp_number: "n\xFAmero do whatsapp",
    name: "Nome",
    date_of_birth: "data de nascimento",
    place_order_necessary_information: "para realizar o pedido, \xE9 necess\xE1rio preencher as informa\xE7\xF5es acima",
    order_slip: "Nota de Pedido",
    order_slip_s: "Notas de Pedido",
    no_active_orders: "n\xE3o h\xE1 pedidos ativos",
    order_sucess: "pedido realizado com sucesso",
    send_confirmation_whatsapp: "enviar confirma\xE7\xE3o por whatsapp",
    select_delivery_date: "selecionar uma data de entrega",
    time_zone_is_different: "Identific\xE1mos que o seu fuso hor\xE1rio \xE9 diferente do fuso hor\xE1rio do estabelecimento. O tempo de rece\xE7\xE3o correspondente ser\xE1 mostrado ao lado da hora",
    delivery_time_between: "escolha um hor\xE1rio de entrega entre os per\xEDodos",
    delivery_for_order: "escolha uma entrega para o seu pedido",
    establishment_notes: "notas do estabelecimento",
    notes: "Notas",
    no_more_avaible_slots_for_orders: "n\xE3o temos mais hor\xE1rios dispon\xEDveis para pedidos. por favor, contacte o nosso estabelecimento",
    contact_establishment: "contactar o estabelecimento",
    no_slots_avaible_for_orders_on_that_day: "n\xE3o temos mais hor\xE1rios dispon\xEDveis para pedidos nesse dia",
    please_select_another_date: "por favor, selecione outra data.",
    continue: "continuar",
    last_orders: "\xDAltimos Pedidos",
    date: "Data",
    ...
    add_new_addresses: "adicionar novos endere\xE7os",
    create_address_or_use_list_below: "criar um novo endere\xE7o ou usar a lista abaixo",
    more_information: "mais informa\xE7\xF5es",
    notification_permissions: "para receber notifica\xE7\xF5es, precisa de conceder permiss\xF5es de notifica\xE7\xE3o no seu dispositivo.",
    opening_hours: "hor\xE1rio de abertura",
    from: "de",
    from_de: "De",
    to: "at\xE9",
    pay_online: "pagar online",
    choose_this_option_secure_payment: "escolha esta op\xE7\xE3o para fazer um pagamento seguro atrav\xE9s do nosso sistema online.",
    choose_option_receiving: "prefere pagar na rece\xE7\xE3o do seu pedido? escolha esta op\xE7\xE3o.",
    acess_your_payment_app: "aceda \xE0 sua app de pagamento",
    qrcode_copy_paste_payment: "escaneie o c\xF3digo QR ou copie e cole o c\xF3digo de pagamento",
    pay_credited_instantly: "pague e ser\xE1 creditado instantaneamente",
    enter_your_cpf: "Introduza o seu NIF",
    local_pickup: "levantamento local",
    disc: "Desc.",
    payment_still_pending: "pagamento ainda pendente. por favor, tente novamente.",
    confirmation_is_taking_too_long: "se a confirma\xE7\xE3o estiver a demorar muito, clique no bot\xE3o para prosseguir.",
    use_delivery_address: "usar endere\xE7o de entrega",
    city: "Cidade",
    address: "endere\xE7o",
    state: "estado",
    ...
    required: "obrigat\xF3rio",
    cash_payment: "pagamento em dinheiro",
    card_network: "rede do cart\xE3o",
    payment_meal_voucher: "pagamento por vale refei\xE7\xE3o.",
    payment_food_voucher: "pagamento por vale alimenta\xE7\xE3o",
    receipt_to_our_whatsapp: "envie o recibo para o nosso whatsapp para agilizar o seu atendimento",
    total_to_transfer: "total a transferir",
    type_of_key: "tipo de chave",
    type: "tipo",
    save_future_purchases: "guardar para futuras compras",
    finalize_order: "finalizar pedido",
    add_ons: "Complementos",
    add_on: "Complemento",
    error_generating_qrcode: "Erro ao gerar c\xF3digo QR. Por favor, tente novamente.",
    payment_not_detected_check_banking: "Pagamento n\xE3o detetado. Por favor, verifique a sua app banc\xE1ria.",
    error_processing_payment: "Erro ao processar o pagamento, por favor, tente novamente.",
    error_creating_customer: "Erro ao criar cliente. Por favor, tente novamente.",
    choose_single_crust: "escolher a massa simples",
    choose_single_crust_comment: "Escolher Massa Simples",
    choose_crust_comment: "Escolher Massa",
    crust_without_filling: "massa sem recheio",
    choose_the: "escolher o",
    choose_the_o: "escolher o",
    attention: "Aten\xE7\xE3o",
    complete_order_mandotory: "complete o seu pedido com os itens obrigat\xF3rios",
    no_orders_moment: "nenhum pedido no momento",
    fees: "taxas",
    fee_comment: "Taxa",
    delivery_fee: "taxa de entrega",
    calculate: "calcular",
    pickup_only: "apenas levantamento",
    loading_dates: "a carregar datas",
    choose_date: "escolher uma data",
    see_full_list: "clique aqui para ver a lista completa de produtos",
    no_products_found: "desculpe, nenhum produto encontrado",
    size_unavilable: "tamanho indispon\xEDvel",
    ...
    remove_item: "remover item",
    point_camera_qrcode: "por favor, aponte a sua c\xE2mara para o c\xF3digo QR na mesa onde deseja fazer o seu pedido",
    order_status: "status do pedido",
    order: "Pedido",
    in_preparation: "em prepara\xE7\xE3o",
    canceled: "cancelado",
    order_received: "pedido recebido",
    pending_payment: "pendente de pagamento",
    order_approved: "pedido aprovado",
    phone_footer: "Telefone",
    order_preparation: "pedido em prepara\xE7\xE3o",
    order_canceled: "pedido cancelado",
    order_out_for_delivery: "pedido em rota de entrega",
    order_ready_for_pickup: "Pedido Pronto Para Entrega",
    send_order_whatsapp: "enviar pedido por whatsapp",
    coupon: "Cup\xE3o",
    reference_point: "ponto de refer\xEAncia",
    reference: "Refer\xEAncia",
    house_corner: "Canto da casa",
    neighborhood: "Localidade",
    address_complement: "Complemento de Endere\xE7o",
    number: "N\xFAmero",
    block_apt: "Bloco, Apt",
    ave: "Av. Times Square",
    date_usa: "dd/mm/yyyy",
    choose_time: "Escolher uma Hora",
    minimum_quantity: "Quantidade m\xEDnima",
    maximum_quantity: "Quantidade m\xE1xima",
    user: "utilizador",
    cancel: "Cancelar",
    cancel_order: "Cancelar Pedido",
    repeat_order: "repetir pedido",
    activate: "ativar",
    pick_up_counter: "Levantar no Balc\xE3o",
    counter_and_delivery: "Balc\xE3o/Entrega",
    discount: "desconto",
    discount_comment: "Desconto",
    discount_of: "desconto de",
    applied: "aplicado",
    change_address: "alterar endere\xE7o",
    summary: "Resumo",
    message_no_costumer_selected: "Nenhum cliente selecionado para este pedido. Por favor, procure um cliente registado ou registe um novo para prosseguir.",
    search_customer: "procurar cliente",
    add_customer: "adicionar cliente",
    proceed: "prosseguir",
    outside_service_area: "FORA DA \xC1REA DE SERVI\xC7O",
    free_comment: "Gr\xE1tis",
    activate_coupon_comment: "Ative o seu Cup\xE3o",
    order_type: "tipo de pedido",
    place_order: "fazer pedido",
    open_register: "abrir caixa",
    initial_balance: "Saldo Inicial \u20AC",
    initial_balance_n: "Saldo Inicial",
    income: "receita",
    cash_register_status: "status da caixa",
    cash_outflow: "sa\xEDda de caixa",
    value: "valor",
    description: "descri\xE7\xE3o",
    code: "c\xF3digo",
    close_cash_register: "fechar caixa",
    cash_balance: "saldo de caixa",
    cashier_balance: "saldo do caixa",
    final_balance: "saldo final",
    new_order: "Novo Pedido",
    counter: "Balc\xE3o",
    create_order_slip: "criar nota de pedido",
    change_tables: "mudar mesas",
    change_table: "mudar mesa",
    table_change: "mudan\xE7a de mesa",
    print_table: "imprimir mesa",
    printer: "impressora",
    close_table: "fechar mesa",
    phone: "Telefone",
    client: "Cliente",
    client_comment: "Cliente",
    no_registred_address: "nenhum endere\xE7o registado",
    none: "nenhum",
    charge: "cobran\xE7a",
    qty: "qtd.",
    standard: "Padr\xE3o",
    search_name_comment: "Procurar por Nome",
    search_flavor_comment: "Procurar por Sabor",
    occupied: "ocupado",
    paused: "pausado",
    waiting_service: "aguardando atendimento",
    pause_comment: "Pausar",
    unpause_comment: "Retomar",
    order_buy: "pedido",
    clear: "limpar",
    order_the_table: "pedido na mesa",
    registration_comment: "Registo",
    change_comment: "Alterar",
    one_more_comment: "Mais um",
    customer: "clientes",
    customer_name_comment: "Nome do cliente",
    ...
    number_comment: "N\xFAmero",
    no_number: "sem n\xFAmero",
    dont_know_my_zip: "n\xE3o sei o meu c\xF3digo postal",
    other_s: "Outros",
    deliver_this_address: "Entregar neste Endere\xE7o",
    delivery_date: "data de entrega",
    out_coverage_area: "fora da \xE1rea de cobertura",
    technology: "Tecnologia",
    finalize_appointment: "finalizar marca\xE7\xE3o",
    next_confirm: "Pr\xF3ximo/Confirmar",
    shortcuts: "atalhos",
    return_cancel: "Voltar/Cancelar",
    return: "Voltar",
    ...
    remaining: "restante",
    fee_discount: "Taxa/Desconto",
    how_pay_pix: "Como Pagar Com PIX",
    step: "passo",
    payment_deadline: "o prazo de pagamento \xE9 em",
    select_comment: "Selecionar",
    call_back_house: "Ex: Ligar na Casa dos Fundos",
    change_for: "trocar por",
    change_for_comment: "Trocar Por",
    for: "para",
    out_for_delivery: "em rota de entrega",
    waiting_for_pickup: "aguardando levantamento",
    add_flavor: "adicionar sabor",
    your_flavor: " seu sabor",
    choose: "Escolher",
    selected_date_is_earlier: "a data selecionada \xE9 anterior \xE0 data atual",
    complete: "completar",
    register_closing: "fecho da caixa",
    confirm_register_closing: "confirmar fecho da caixa",
    closing_insert_following: "durante o fecho, insira os seguintes valores na sua gaveta de caixa",
    register_login: "login na caixa",
    password: "senha",
    deposit: "Dep\xF3sito",
    ...
    products: "produtos",
    uncancel_order: "reverter cancelamento de pedido",
    order_amount: "valor total do pedido",
    print_the: "imprimir o",
    change: "Troco",
    next_flavor_comment: "Pr\xF3ximo Sabor",
    choose_flavor_comment: "Escolher um Sabor",
    quantity_unavaible: "Quantidade Indispon\xEDvel",
    complete_toppings_comment: "Complementos Completos",
    out_stock_toppings_comment: "Complementos Fora de Stock",
    in_stock_comment: "Em Stock",
    the_flavors_comment: "os Sabores",
    the_crust_comment: "a Massa",
    the_toppings_comment: "os Complementos",
    mandatory_to_choose: "\xE9 obrigat\xF3rio escolher",
    time_closed_comment: "Hora Fechada!",
    change_less_purchase_comment: "Troco inferior ao valor da compra",
    free_shipping_comment: "ENVIO GR\xC1TIS",
    consult_comment: "Consultar",
    location_comment: "Localiza\xE7\xE3o",
    paid_online_comment: "Pago Online",
    track_order: "Rastrear pedido",
    street: "Rua",
    pickup_the_location: "Vou levantar no local",
    order_comment: "Pedido",
    schedule: "Agendar",
    ...
    no_product_found: "nenhum produto encontrado",
    items_found: "itens encontrados",
    mandatory_items: "itens obrigat\xF3rios",
    minimum: "m\xEDnimo",
    card: "Cart\xE3o",
    ...
    select_city: "Selecione a cidade",
    enter_neighborhood: "Insira a localidade",
    select_neighborhood: "Selecione a localidade",
    enter_street_name: "Insira o nome da rua",
    coupon_only_used_purchases: "Este cup\xE3o s\xF3 pode ser utilizado em compras a partir de",
    discount_coupon_greater_total: "O desconto no cup\xE3o \xE9 superior ao valor total!",
