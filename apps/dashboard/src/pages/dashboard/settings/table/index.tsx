              ...
              <Tab.Content>
                  ...
                  <Card className="card-create">
                    <Card.Header>
                      <div className="d-flex justify-content-between">
                        ...
                        <HelpVideos.Trigger urls={[{ src: 'https://www.youtube.com/embed/AS0E8jbk1-M', title: 'Criando taxas' }]} />
                      </div>
                    </Card.Header>
                    <Card.Body>
                ...
                <Tab.Pane eventKey="bartenders">
                  <Card className="card-create">
                    <Card.Header>
                      <div className="d-flex justify-content-between">
                        <h6>Registrar Garçom</h6>
                        <HelpVideos.Trigger
                          urls={[
                            { src: 'https://www.youtube.com/embed/rYpj9BSBpSU', title: 'Cadastrando garçom' },
                            { src: 'https://www.youtube.com/embed/h1VhzXvLwWo', title: 'Fazendo um pedido como garçom' },
                          ]}
                        />
                      </div>
                    </Card.Header>
