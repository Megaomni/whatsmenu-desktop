...
export default function Recovery({ expired, user }: RecoveryProps) {
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      await apiRoute("/user/passwordForgot", undefined, "POST", { user_email: user.email, password, password_confirm })
      setToast({
        type: "success",
  ...
  function preventInsecurePassword() {
    if (password === '123456') return 'Essa senha não é segura o suficiente. Por favor, escolha outra.'
                ...
                <div className="col-md-7">
                  ...
                  <form onSubmit={(e) => {
                    ...
                    <div className="d-grid gap-2">
                      <button className="btn btn-success" type="submit" disabled={!!preventInsecurePassword()} >
                        Salvar
                      </button>
                    </div>
