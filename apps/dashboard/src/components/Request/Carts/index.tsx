...
export function Carts(data: any) {
  ...
  const { setRequestsToPrint, door, possibleMobile, lastRequestDate, currency } = useContext(AppContext)
                  ...
                  <Row className="align-items-baseline mb-3">
                    <Col md="8" className="d-flex flex-column flex-md-row gap-3">
                      <FormGroup className="d-flex flex-column flex-md-row gap-2 fs-6 align-items-center justify-content-start">
                        <Form.Label className="fs-7 m-0 d-block">{t('caption')}:</Form.Label>
                        {[
                      ...
                      <HelpVideos.Trigger
                        ...
                        urls={[{ src: 'https://www.youtube.com/embed/RX-j14y3Sc0', title: t('order_list') }]}
                      />
                    </Col>
                    <Col md="4" className="d-flex gap-2 text-nowrap justify-content-end">
                      <FormGroup className="fs-6 px-2 pe-0 d-flex gap-2 align-items-baseline justify-content-end">
                        <Form.Label className="fs-7">{t('filter_o')}:</Form.Label>
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  ...
                                  {possibleMobile && !cart.print && <span className="fs-8 d-inline-block ms-1 fw-bold">&lt;- {t('press')}</span>}
                                </div>
                              </td>
                              <td
                            ...
                            >
                              ...
                              >
                                <span className="align-middle fs-7 d-flex flex-row gap-2 align-items-center">
                                  {cart.type === 'T'
                                    ? '-'
                                    : Array.from(new Set(cart.formsPayment.map((formPayment) => i18n.t(formPayment.payment)))).join(', ')}
                              ...
                              <td className="setPrint align-text-left" width={50} data-title={`${t('change')}:`}>
                                <span className="align-middle fs-7">
                                  ...
                                  <>
                                    <div className="d-flex gap-2 me-1" id="container-buttons" style={{ width: 250 }}>
                                      ...
                                      <SendStatusMessageForm
                                        ...
                                        newStatus="transport"
                                        button={{
                                          name: cart.type === 'T' ? t('served') : !cart.addressId ? t('ready_for_pickup') : t('delivering'),
                                          props: {
