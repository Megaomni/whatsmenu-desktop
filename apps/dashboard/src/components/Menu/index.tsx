  ...
  const pauseCategory = async (cat: Category) => {
    ...
    try {
      ...
      handleShowToast({
        ...
        type: 'success',
        title: 'category',
        content: `${cat.name}, foi ${!cat.status ? t('pause') : t('unpause')} ${t('sucessfully')}.`,
      })
    } catch (error) {
      console.error(error)
      handleShowToast({
  ...
  const pauseProduct = async (productMap: Product) => {
    ...
    try {
      ...
      handleShowToast({
        ...
        type: 'success',
        title: 'order',
        content: `${productMap.name}, foi ${!productMap.status ? t('paused') : 'unpaused'} ${t('sucessfully')}.`,
      })
    } catch (error) {
      console.error(error)
      handleShowToast({
    ...
    try {
      if (categoryMap.product) {
        ...
        handleShowToast({
          ...
          type: 'success',
          title: titleMessage,
          content: `${itemToPause.name}, foi ${itemToPause.status ? t('paused') : 'unpaused'} ${t('sucessfully')}.`,
        })
      }
    } catch (error) {
      console.error(error)
