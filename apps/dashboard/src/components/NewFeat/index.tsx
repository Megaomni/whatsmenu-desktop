  ...
  return (
    <Card>
      ...
      <Card.Body className="overflow-auto" style={{ maxHeight: '78vh' }}>
        <Alert variant="primary" className="text-primary">
          <Row className="align-items-center mb-2">
            ...
            <Col sm className="p-0">
              {isNextDomain ? (
                <p className="m-0">
                  <b>Recursos {feature.name}</b>
                </p>
              ) : (
                <p className="m-0">
                  <b>A partir de {feature.day}, o {feature.name} estará disponível no seu painel, sem custo extra! 😃  Com esta incrível adição:</b>
                </p>
              )}
            </Col>
          </Row>
        ...
        <p className="mt-4 px-3">Confira os vídeos abaixo para saber todos os detalhes!  Estamos trazendo isso em primeira mão para você, porque merece o melhor 🌟</p>
