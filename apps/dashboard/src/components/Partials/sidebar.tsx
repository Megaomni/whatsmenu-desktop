    ...
    <>
      <ul className="sidebar-nav" id="sidebar-nav">
          ...
          <>
            ...
            <li className="nav-item">
              ...
              >
                <BsCashCoin />
                <span>Cashback</span>
                <span className="badge bg-danger inline ms-3">{t('new')}</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link
        ...
        <li className="nav-item">
          ...
          >
            <FaBarcode />
            <span className="d-flex justify-content-between align-items-center w-100">{t('invoices')}</span>
          </Link>
        </li>
        ...
        <li className="nav-item">
          ...
          >
            ...
            {updates.some((update) => {
              ...
              <span className="badge bg-danger inline ms-3 pulseElement">{t('new')}</span>
            ) : null}
          </Link>
        </li>
        <li className="nav-item">
      ...
      <div className="p-3 mb-3 mt-5 rounded-3 bg-primary text-white">
        ...
        <p className="text-center mt-2 mb-0">{t('support_hours')}</p>
      </div>
    </>
  )
}
