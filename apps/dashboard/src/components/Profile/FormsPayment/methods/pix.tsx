...
const OnlinePaymentSettings = ({ formPayment }: PaymentSettingsProps) => {
  ...
  const keyArray = formPayment?.payment === 'pix' ? ['Telefone', 'E-mail', 'CPF', 'CNPJ', 'Aleatória'] : ['Usuário', 'Email']
  const addonType = ['Desconto', 'Acréscimo']
  const addonTypeValue = ['Fixo', 'Percentual']
          ...
          <Card.Header className="text-dark d-flex justify-content-between">
            ...
            <div className="d-flex gap-5">
              <Form.Switch
                ...
                label={pixSettings.status ? 'Ativado' : 'Desativado'}
                className="fs-4"
