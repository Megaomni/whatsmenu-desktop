...
export default class Gateway {
    ...
    async addSubscriptionDiscount(discount: AddSubscriptionDiscountContracts) {
        ...
        throw {
            message: "This gateway does not have the function to add subscription discount"
        }
    };
    ...
    async addSubscriptionItem(item: AddSubscriptionItemContracts) {
        ...
        throw {
            message: "This gateway does not have the function to add subscription item"
        }
    }

    async addSubscriptionIncrements(increment: AddSubscriptionIncrementContracts) {
        if (this.gateway.addSubscriptionIncrement) {
            return await this.gateway.addSubscriptionIncrement(increment);
        }

        throw {
            message: "This gateway does not have the function to add subscription increment"
        }
    }
    ...
    async chargeAutomatically(data: ChargeAutomaticallyContracts) {
        ...
        throw {
            message: "This gateway does not have the function to charge automatically"
        }
    ...
    async changeSubscriptionCard(cardId: string) {
        ...
        throw {
            message: "This gateway does not have the function to change subscription card"
        }
