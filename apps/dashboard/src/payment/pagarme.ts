...
export default class StrategyPagarme implements GatewayStrategy {
  ...
  public async addSubscriptionDiscount(data: AddSubscriptionDiscountContracts) {
    return await apiRoute(
      '/pagarme/subscription/increments',
      this.session,
      'POST',
      {
        value: data.value,
  ...
  public async addSubscriptionIncrement(
    data: AddSubscriptionIncrementContracts
  ) {
    return await apiRoute(
      '/pagarme/subscription/increments',
      this.session,
  ...
  public async chargeAutomatically(data: ChargeAutomaticallyContracts) {
    return await apiRoute(
      '/pagarme/createCheckoutOrPurcharseCard',
      this.session,
      'POST',
      data
    )
  ...
  public async changeChargeCard(
    cardId: string,
    data: ChangeChargeCardContracts
  ) {
    return await apiRoute('/pagarme/changeChargeCard', this.session, 'PATCH', {
      cardId,
      ...data,
    })
  }
  ...
  public async changeSubscriptionCard(cardId: string) {
    return await apiRoute(
      '/pagarme/changeSubscriptionCard',
      this.session,
      'PATCH',
      { cardId }
    )
