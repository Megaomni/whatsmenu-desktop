    ...
    createClass(Emittery, [
        ...
        value: (function () {
          var _ref = asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(
              function _callee3(eventName, eventData) {
                var _this2 = this
                    ...
                    while (1) {
                      switch ((_context3.prev = _context3.next)) {
                        case 0:
                          ...
                          staticListeners = [].concat(
                            toConsumableArray(listeners)
                          )
                          staticAnyListeners = [].concat(
                            toConsumableArray(anyListeners)
                          )
                          _context3.next = 7
      ...
      },
      {
        ...
        value: (function () {
          var _ref4 = asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(
              function _callee4(eventName, eventData) {
                var listeners,
                  anyListeners,
                  staticListeners,
                  staticAnyListeners,
      ...
      },
      {
        ...
        value: function listenerCount(eventName) {
          ...
          try {
            for (
              var _iterator4 = eventsMap.get(this).values()[Symbol.iterator](),
                _step4;
  ...
  var wsp_browser = createCommonjsModule(function (module, exports) {
    !(function (t, e) {
      ...
      return (
        ...
        (n.isValidJoinPacket = n.hasTopic),
        (n.isValidLeavePacket = n.hasTopic),
        (n.isValidEventPacket = n.hasTopic),
        (n.joinPacket = function (t) {
        ...
        (n.leaveErrorPacket = function (t, n) {
          return o(e.LEAVE_ERROR, { topic: t, message: n }, [
            'topic',
            'message',
          ])
        }),
        (n.eventPacket = function (t, n, i) {
          return o(e.EVENT, { topic: t, event: n, data: (i = i || '') }, [
            'topic',
            'event',
          ])
        }),
      ...
      [
        {
          ...
          value: function joinAck() {
            ...
            {
              Debug(
                'clearing emit buffer for %s topic after subscription ack',
                this.topic
              )
            }
    ...
    createClass(Connection, [
      ...
      },
      {
        ...
        value: function _ensureSubscription(packet, cb) {
          ...
          if (!socket) {
            {
              Debug(
                'cannot consume packet since %s topic has no active subscription %j',
                packet.d.topic,
                packet
              )
            }
      ...
      },
      {
        ...
        value: function _processQueue() {
          ...
          this.options.encoder.encode(
            this._packetsQueue.shift(),
      ...
      },
      {
        ...
        value: function _onClose(event) {
          ...
          this.emit('close', this)
            .then(function () {
              _this5.shouldReconnect
                ? _this5._reconnect()
                : _this5.clearListeners()
            })
            .catch(function () {
              _this5.shouldReconnect
                ? _this5._reconnect()
      ...
      },
      {
        ...
        value: function _handleOpen(packet) {
          ...
          {
            Debug(
              'processing pre connection subscriptions %o',
      ...
      },
      {
        ...
        value: function connect() {
          ...
          var query = stringify(
            _extends({}, this.options.query, this._extendedQuery)
          )
      ...
      },
      {
        ...
        value: function write(payload) {
          if (this.ws.readyState !== window.WebSocket.OPEN) {
            {
              Debug(
                'connection is not in open state, current state %s',
                this.ws.readyState
              )
            }
            return
      ...
      },
      {
        ...
        value: function subscribe(topic) {
          if (!topic || typeof topic !== 'string') {
            throw new Error(
              'subscribe method expects topic to be a valid string'
            )
          }

          if (this.subscriptions[topic]) {
            throw new Error(
              'Cannot subscribe to same topic twice. Instead use getSubscription'
            )
          }
      ...
      },
      {
        ...
        value: function sendEvent(topic, event, data) {
          if (!topic || !event) {
            throw new Error(
              'topic and event name is required to call sendEvent method'
            )
          }
          ...
          if (!subscription) {
            throw new Error(
              'There is no active subscription for ' + topic + ' topic'
            )
          }
          ...
          if (subscription.state !== 'open') {
            throw new Error(
              'Cannot emit since subscription socket is in ' +
                this.state +
                ' state'
            )
          }
