...
const providers = [
  ...
  path.join(__dirname, '..', 'providers', 'WmProvider'),
  path.join(__dirname, '..', 'providers', 'GoogleProvider'),
  path.join(__dirname, '..', 'providers', 'PixGeneratorProvider'),
  path.join(__dirname, '..', 'providers', 'AsaasProvider'),
  path.join(__dirname, '..', 'providers', 'InventoryProvider'),
]
