...
class Profile extends Model {
  ...
  static boot() {
    ...
    this.addHook('afterFind', (profile) => {
      ...
      if (!profile.options.placeholders.hasOwnProperty('cupomFirstMessage')) {
        profile.options.placeholders.welcomeMessage = Profile.defaultCupomFirstMessage(profile)
      }
  ...
  categories() {
    return this.hasMany('App/Models/ReadOnly/Category', 'id', 'profileId').where('deleted_at', null)
  }

  clients() {
    return this.hasMany('App/Models/ReadOnly/Client', 'id', 'profileId')
  }

  allCategories() {
    return this.hasMany('App/Models/ReadOnly/Category', 'id', 'profileId')
  }

  requests() {
    return this.hasMany('App/Models/ReadOnly/Request', 'id', 'profileId')
  }

  carts() {
    return this.hasMany('App/Models/ReadOnly/Cart', 'id', 'profileId').whereRaw('(statusPayment in ("offline", "paid") or statusPayment is null)')
  }

  motoboys() {
    return this.hasMany('App/Models/ReadOnly/Motoboy', 'id', 'profileId').where('deleted_at', null)
  }
  ...
  cupons() {
    return this.hasMany('App/Models/ReadOnly/Cupom', 'id', 'profileId')
  }

  domains() {
    return this.hasMany('App/Models/ReadOnly/Domain', 'id', 'profileId')
  }

  tables() {
    return this.hasMany('App/Models/ReadOnly/Table', 'id', 'profileId')
  }

  activeTables() {
    return this.hasMany('App/Models/ReadOnly/Table', 'id', 'profileId').where('deleted_at', null)
  }

  bartenders() {
    return this.hasMany('App/Models/ReadOnly/Bartender', 'id', 'profileId')
  }

  cashiers() {
    return this.hasMany('App/Models/ReadOnly/Cashier', 'id', 'profileId')
  }

  fees() {
    return this.hasMany('App/Models/ReadOnly/Fee', 'id', 'profileId')
  }
