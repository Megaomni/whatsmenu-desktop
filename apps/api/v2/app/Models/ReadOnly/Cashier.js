...
class Cashier extends Model {
  ...
  carts() {
    return this.hasMany('App/Models/ReadOnly/Cart', 'id', 'cashierId').whereNot('type', 'T').whereRaw('(statusPayment in ("offline", "paid") or statusPayment is null)')
  }

  allCarts() {
    return this.hasMany('App/Models/ReadOnly/Cart', 'id', 'cashierId').whereRaw('(statusPayment in ("offline", "paid") or statusPayment is null)')
  }

  openeds() {
    return this.hasMany('App/Models/ReadOnly/TableOpened', 'id', 'cashierId').where('status', 0)
  }
}
