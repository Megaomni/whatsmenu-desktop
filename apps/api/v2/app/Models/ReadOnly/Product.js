...
class Product extends Model {
  ...
  complements() {
    return this.belongsToMany('App/Models/ReadOnly/Complement', 'productId', 'complementId', 'id', 'id').pivotTable('product_complements')
  }

  category() {
    return this.belongsTo('App/Models/ReadOnly/Category', 'categoryId', 'id')
  }

  cartItens() {
    return this.hasMany('App/Models/ReadOnly/CartIten', 'id', 'productId')
  }
}
